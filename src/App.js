      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"5px"}}>
        ...
        {!editing
          ...
          : <div style={{display:"flex",gap:"4px"}}>
              ...
              <button onClick={()=>{ setReqData(p=>({...p,[name]:draft})); setEditing(false); }} style={{fontSize:"9px",color:"#fff",background:partColor,border:"none",borderRadius:"6px",padding:"2px 8px",cursor:"pointer",fontWeight:"700"}}>저장</button>
            </div>
        }
      </div>
      {!editing
